...
export const updateColumnDetailsAPI = async (columdId, updateData) => {
	const response = await axios.put(`${API_ROOT}/v1/columns/${columdId}`, updateData)
	return response.data
}

export const deleteColumnDetailsAPI = async (columdId) => {
	const response = await axios.delete(`${API_ROOT}/v1/columns/${columdId}`)
	return response.data
}
